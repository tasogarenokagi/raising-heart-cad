...
module trailing_edge() {
    ...
    //Internal shim to correctly join rendered mesh
    polyhedron(points = [
            [each trailing_edge_vertices[3], root_height],
            [each trailing_edge_vertices[3], -root_height],
            [each trailing_edge_vertices[2], 0],

            [trailing_edge_vertices[3][0] + 1, trailing_edge_vertices[3][1], root_height],
            [trailing_edge_vertices[3][0] + 1, trailing_edge_vertices[3][1], -root_height],
            [trailing_edge_vertices[2][0] + 1, trailing_edge_vertices[2][1], 0]
